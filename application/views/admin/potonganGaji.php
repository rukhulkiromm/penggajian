...
<table class="table table-bordered table-striped">
    ...
    <?php $no=1; foreach($pot_gaji as $p) : ?>
        <tr>
            ...
            <td>
                <center>
                <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/potonganGaji/updateData') ?>"><i class="fas fa-edit"></i></a>
                <a onclick="return confirm('Yakin Hapus?')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/potonganGaji/deleteData') ?>"><i class="fas fa-trash"></i></a>
                </center>
            </td>
        </tr>
        <?php endforeach; ?>
