...
<a href="<?php echo base_url('admin/dataAbsensi/inputAbsensi') ?>" clas="btn btn-success mb-2 ml-3"><i class="fas fa-plus"></i> Input Kehadiran</a>
</form>
...
<div class="alert alert-info">
    Menampilkan Data Kehadiran Pegawai Bulan: <span class="font-weight-bold"><?php echo $bulan ?> Tahun: <span class="font-weight-bold"><?php echo $tahun ?> 
</div>
